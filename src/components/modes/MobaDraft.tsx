...
export const MobaDraft: React.FC<MobaDraftProps> = ({ blueTeamName, redTeamName, opponentPool, teamSize, onDraftComplete }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full p-4">
      <div className="flex items-center justify-between w-full max-w-4xl mb-4">
        ...
        <h2 className="font-black text-2xl font-mono text-white">DRAFT PHASE</h2>
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="col-span-1 flex flex-col gap-2 bg-slate-900 rounded-xl p-4 border border-slate-700">
          ...
          {selectedChampion ? (
            <button onClick={() => handlePick(selectedChampion)} className="w-full py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black rounded-lg font-mono text-sm">
